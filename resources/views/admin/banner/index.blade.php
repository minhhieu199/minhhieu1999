...
@section('content')
    <section class="content-header">
        <h1>
            Quản lí Banner <a href="{{route('admin.banner.create')}}" class="btn btn-info pull-right"><i class="fa fa-plus"></i> Thêm Banner</a>
        </h1>
    </section>
                                ...
                                <tr class="item-{{ $item->id }}"> <!-- Thêm Class Cho Dòng -->
                                   ...
                                   <td class="text-center">
                                    ...
                                    <td class="text-center">
                                        ...
                                        <a href="javascript:void(0)" class="btn btn-danger btnDlete" data-id="{{$item->id}}" >Xóa</a>
                                    </td>
                                </tr>
                            @endforeach
                        </table>
